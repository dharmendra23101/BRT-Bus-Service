  ...
  return (
    ...
    >
      <nav className="bg-primary text-primary-foreground flex justify-center gap-6 py-3">
        <Link
          to="/"
          className="text-primary-foreground no-underline hover:opacity-80 transition-opacity"
        >
          Home
        </Link>
        <Link
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-48px)] px-4">
        <div
          ...
          style={{
            boxShadow:
              "0 8px 32px hsla(284,33%,30%,0.12), 0 16px 48px hsla(284,33%,30%,0.08)",
          }}
        >
          {/* SIGN UP FORM */}
          ...
          >
            <div
              className="h-full flex items-center justify-center px-8 text-center text-white"
              style={{
                background:
                  "linear-gradient(to right, hsl(284, 33%, 52%), hsl(284, 33%, 42%))",
              }}
            >
              {!isActive ? (
                <div>
